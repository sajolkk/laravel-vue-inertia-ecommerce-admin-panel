...
<template>
    <div>
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-start">
            <div class="hidden md:block w-[300px] shadow-2xl h-screen dark:bg-gray-800 py-2 fixed top-0 left-0">
                <!-- Fixed Top Logo Section -->
                <div class="sticky top-0 bg-gray-800 z-10">
                    <a href="" class="flex justify-center items-center cursor-pointer text-gray-300 hover:text-white pb-[10px] border-b-[1px] border-gray-600">
                        <div>
                        <img src="https://admin.sopmatech.com/assets/uploads/setting/logo/1705161862.jpeg" width="70" alt="">
                        </div>
                ...
                <nav class="pt-1 mt-2 h-[calc(100vh-80px)] overflow-y-auto scrollbar px-2">
                    <ul class="list-none space-y-1">
                        <template v-for="menu in menus" :key="menu.name">
                            <li v-if="menu.isSubMenu" class="group text-gray-300 hover:text-white ">
                                <div class="flex justify-between items-center cursor-pointer py-2 rounded-md hover:bg-[#ffffff33] px-2">
                                    <!-- bg-[#78aaf03b] -->
                                    <div>
                                        <span class="pr-2 w-[60px]">
                                            <FontAwesomeIcon :icon="['fas', menu.icon]" size="xl"/>
                                        </span>
                                        <span class="px-0">PC Builder Component</span>
                                    </div>
                                    <div>
                                ...
                                <ul id="submenu" class="pl-2 bg-[#8080800f] rounded hidden">
                                    <li class="py-1 rounded-md cursor-pointer text-gray-300 hover:text-white hover:bg-[#ffffff33] px-2">
                                        <a href="">
                                            <span class="pr-2">
                            ...
                            <li v-else class="py-2 rounded-md cursor-pointer text-gray-300 hover:text-white hover:bg-[#ffffff33] px-2">
                                <a href="">
                                    <span class="pr-2">
                                        <FontAwesomeIcon :icon="['fas', menu.icon]" size="xl"/>
                                    </span>
